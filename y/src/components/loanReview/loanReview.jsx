      ...
      <div class="review-container">
        <div class="review-card">
          ...
          <p>
            ...
            me a personal loan, then my friend told me about My ScopeS and after
        ...
        <div class="review-card">
          ...
          <p>
            My ScopeS helped me in getting a personal loan for my wedding. I was
            ...
            colleagues to My ScopeS for applying any type of loan.
          </p>
          <div class="author-info">
        ...
        <div class="review-card">
          ...
          <p>
            I took a personal loan through My ScopeS and used it to clear my
        ...
        <div class="review-card">
          ...
          <p>
            The comparison table, which My ScopeS have provided on their
            website, is best. As it is very useful for every loan seeker. Using
            that table i applied with YES bank as it suited best to my
            requirements.
          </p>
          <div class="author-info">
            <h4>PRIJESH SAHOO</h4>
