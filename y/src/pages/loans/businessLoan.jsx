    ...
    <div className=" container personal-loan">
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            partnerships, limited liability companies (LLCs), corporations, and
            more.
          </li>
          <li>
            <strong>Credit Score:</strong> A good credit score is often required
            to qualify for a business loan. Lenders use your credit history to
          ...
          <li>
            <strong>Age Criteria:</strong> Minimum 21 years at the time of loan
            application & Maximum 65 years at the time of loan maturity.
          </li>
          <li>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            Address proof for Business such as the Telephone Bill or Electricity
            Bill
          </li>
          <li>
      ...
      <div>
        ...
        <p>
          Using a business loan EMI (Equated Monthly Installment) calculator can
      ...
      <div class="container">
        ...
        <p class="text-center margin-b-2">
          ...
          fair idea of the fees and charges related to business loans:
        </p>
