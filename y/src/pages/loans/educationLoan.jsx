  ...
  return (
    <div className=" container personal-loan education-loan">
      ...
      <div>
        ...
        <p>
          Education loan eligibility criteria can vary depending on the country
          of study, the lender, and the type of loan you're applying for.
          However in a general overview the factors that often influence
          education loan eligibility are:
        </p>
        <ul>
          <li>
            <strong>Age</strong> Most lenders have a minimum and maximum age
            requirement for loan applicants. Typically, you need to be of legal
            age (18 or older) to apply for a loan.
          </li>
          <li>
            <strong>Course/Program Eligibility</strong> Education loans are
            often tied to specific educational programs or courses. Lenders may
            have a list of eligible institutions and programs that qualify for
            loans.
          </li>
          <li>
            <strong>Admission Offer</strong> Many lenders require proof of
            admission to an eligible educational institution before approving a
            loan application.
          </li>
          <li>
            <strong>Academic Performance</strong> Some lenders might consider
            your academic performance as part of the eligibility criteria. This
            could include factors like your high school or previous education
            grades.
          </li>
          <li>
            <strong>Co-borrower or Guarantor</strong> If you have limited credit
            history or income, some lenders might require a co-borrower or
            guarantor (usually a parent or guardian) who will share the
          ...
          <li>
            ...
            loan. A good credit history can improve your chances of approval and
            may lead to more favorable loan terms.
          </li>
          <li>
            <strong>Income/Financial Ability</strong> Some lenders may consider
            your ability to repay the loan based on your income or your
          ...
          <li>
            ...
            Lenders may have specific limits on the loan amount they are willing
            to offer.
          </li>
          <li>
            <strong>Collateral or Security</strong> In some cases, lenders might
            require collateral or security against the loan, especially for
            larger loan amounts. This could be in the form of property,
            investments, or other valuable assets.
          </li>
          <li>
            <strong>Documentation</strong> You will likely need to provide
            various documents as part of your loan application, such as proof of
            identity, proof of admission, income documents, and more.
          </li>
        </ul>
        ...
        <p>
          ...
          admission, income documents, and more for both Student as well as the
      ...
      <p>
        Using an Education Loan EMI (Equated Monthly Installment) calculator can
        help you estimate your monthly loan repayment amount.
      </p>
      <p>
      ...
      <ul>
        <li>
          <strong>Input Loan Details</strong> Enter the loan amount you plan to
          borrow, the applicable interest rate, and the repayment tenure (in
          months or years).
        </li>
        <li>
        ...
        <li>
          <strong>View Results</strong> The calculator will display the monthly
          EMI, as well as a breakup of the principal and interest components for
          each payment.
        </li>
        <li>
          <strong>Consider Variations</strong> You can experiment with different
          loan amounts, interest rates, and repayment tenures to see how they
          affect your EMI.
        </li>
        <li>
          <strong>Assess Affordability</strong> The calculated EMI can help you
          determine whether the repayment amount fits within your budget.
        </li>
        <li>
      ...
      <div class="container">
        ...
        <p class="text-center margin-b-2">
          ...
          fair idea of the fees and charges related to education loans:
        </p>
