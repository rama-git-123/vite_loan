    ...
    <div className=" container personal-loan">
      ...
      <div class="container mt-5">
        ...
        <ul>
          ...
          <li>
            Self-Employed Person - Minimum 3 years of Experience in the current
            field
          </li>
        </ul>
      ...
      <div class="container mt-5">
        ...
        <h4 className="margin-t-2 margin-b-2">2. Self-Employed Individuals</h4>
        <ul>
          <li>PAN</li>
          <li>Trade License</li>
      ...
      <div>
        <h4 className="margin-t-2 margin-b-2">EMI Calculator for Home Loan</h4>
        <p>
          ...
          Calculator is essential to make an up-to-date decision to execute your
          Home Loan Plan at optimum levels. This EMI calculator online aids you
          to perform complex computing functions to calculate your Home Loan
          Equated Monthly Instalment accurately in an instant.
        </p>
        <EMICalculator />
      </div>
      ...
      <div class="container">
        ...
        <p class="text-center margin-b-2">
          The fees and charges of home loans usually vary from lender to lender
          and from case to case. The aforementioned table will give you a fair
          idea of the fees and charges related to home loans:
        </p>
