    ...
    <>
      ...
      <div className=" container personal-loan car-loan">
        ...
        <div>
          ...
          <p>
            Car loan eligibility is about whether you can get a loan to buy a
            car. It depends on things like how much you earn, your credit score,
            and if you have other debts. Lenders use these details to decide if
            you can repay the loan. If you meet their criteria, you're eligible
            for the loan; if not, you might need to wait or improve your
            financial situation before getting a car loan.
          </p>
          ...
          <p>
            ...
            debts and liabilities to ensure you can manage the loan. Checking
            with each bank directly or using their online eligibility
            calculators can provide precise criteria tailored to their policies.
          </p>
          <h6 className="margin-t-2 margin-b-2">
          ...
          <ul>
            <li>
              ...
              application and no older than 65 at the end of the loan tenure.
            </li>
        ...
        <div ref={sectionRefs["DOCUMENTS"]}>
          ...
          <p>
            Using a Car Loan EMI (Equated Monthly Installment) calculator can
            help you estimate your monthly loan repayment amount. Follow these
            steps to use a Car Loan EMI calculator effectively:
          </p>
          <ul>
