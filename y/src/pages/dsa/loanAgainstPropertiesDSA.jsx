...
const LoanAgainstPropertiesDSA = ({ mainData }) => {
  return (
    <div>
      <Breadcrumb
        location={location}
        page={"Loan against property dsa agent"}
      />
      <DSAForms title={"Loan Against Property (LAP)"} />
      {/* section 2 */}
      <div class="container my-5 ">
        <h2>Who can Become a Business Loan DSA Partner with Scope?</h2>
        <p>
        ...
        <p>
          ...
          people on the best options. Get your My Scope Loan Agent Partner
      ...
      <div className="eligibility">
        <div className="container">
          <h2>
            What Are The Eligibility Criteria For The My Scope Loan Against
            Property (LAP) DSA Registration Process?
          </h2>
          <p>
      ...
      <div className="container my-5">
        <h2>
          Process Of My Scope Loan Against Property (LAP) DSA Registration
        </h2>
        <p>
      ...
      <div className="container my-5 pertners">
        <h2>Why Partner With My Scope? - Benefits And Perks</h2>
        <p>
      ...
      <div className="container my-5 document">
        <h2>
          Features And Earnings of Loan Against Property (LAP) DSA Program
        </h2>
        <p>
      ...
      <div className="container my-5 dsafaq">
        <h2>Loan Against Property (LAP) DSA FAQs</h2>
...
export default LoanAgainstPropertiesDSA;
