...
const BusinessLoanDSA = ({ mainData }) => {
  return (
    <div>
      <Breadcrumb location={location} page={"Business Loan DSA"} />
      <DSAForms title={"Business"} />
      {/* section 2 */}
      ...
      <div className="eligibility">
        <div className="container">
          <h2>
            What Are The Eligibility Criteria For The My Scope Business Loan DSA
...
export default BusinessLoanDSA;
