...
const AutoLoanDSA = ({ mainData }) => {
  return (
    <div>
      <Breadcrumb location={location} page={"Auto Loan  DSA"} />
      <DSAForms title={"Auto"} />
      {/* section 2 */}
      <div class="container my-5 ">
        <h2>Who can Become a Auto Loan DSA with My Scope?</h2>
        <p>
      ...
      <div className="eligibility">
        <div className="container">
          <h2>
            What Are The Eligibility Criteria For The My Scope Auto Loan DSA
      ...
      <div className="container my-5">
        <h2>Process Of Auto Loan DSA Registration</h2>
        <p>
      ...
      <div className="container my-5 document">
        <h2>Features And Earnings of Auto Loan DSA Program</h2>
        <p>
