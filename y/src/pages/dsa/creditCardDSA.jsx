...
const CreditCardDSA = ({ mainData }) => {
  return (
    <div>
      <Breadcrumb location={location} page={"Credit Card  DSA"} />
      <DSAForms title={"Credit Card"} />
      {/* section 2 */}
      <div class="container my-5 ">
        <h2>Who can Become a Credit Card DSA with My Scope?</h2>
        <p>
      ...
      <div className="eligibility">
        <div className="container">
          <h2>
            What Are The Eligibility Criteria For The My scope Credit Card DSA
      ...
      <div className="container my-5">
        <h2>Process Of Credit Card DSA Registration</h2>
        <p>
      ...
      <div className="container my-5 document">
        <h2>Features And Earnings of Credit Card DSA Program</h2>
        <p>
