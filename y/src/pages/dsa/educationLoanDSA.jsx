...
const EducationLoanDSA = ({ mainData }) => {
  return (
    <div>
      <Breadcrumb location={location} page={"Education Loan  DSA"} />
      <DSAForms title={"Education"} />
      {/* section 2 */}
      <div class="container my-5 ">
        <h2>Who can Become a Education Loan DSA with My Scope?</h2>
        <p>
      ...
      <div className="eligibility">
        <div className="container">
          <h2>
            What Are The Eligibility Criteria For The My Scope Education Loan
      ...
      <div className="container my-5">
        <h2>Process Of Education Loan DSA Registration</h2>
        <p>
      ...
      <div className="container my-5 document">
        <h2>Features And Earnings of Education Loan DSA Program</h2>
        <p>
...
export default EducationLoanDSA;
