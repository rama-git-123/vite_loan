...
import DSAForms from "../../components/dsaForms/dsaForms";
const PersonalLoanDSA = ({ mainData }) => {
  return (
    <div>
      <Breadcrumb location={location} page={"Personal Loan DSA"} />
      <DSAForms title={"Personal"} />
      {/* section 2 */}
      <div class="container my-5 ">
        <h2> What is a Personal Loan DSA?</h2>
        <p>
          A Personal Loan Direct Selling Agent (DSA) is a person or company
          authorized by financial institutions to help borrowers navigate the
          application process. Loan DSAs serve as go-betweens connecting loan
          seekers with lending institutions by identifying potential customers,
          helping them gather the necessary documentation, and then forwarding
          their loan applications to the financial institutions after
          completion. Consequently, they receive payments for each successful
          loan referral they make. Thus, becoming a Personal Loan DSA Partner is
          a great opportunity.
        </p>
        <h2>Who can Become a Personal Loan DSA with My Scope?</h2>
        <p>
      ...
      <div className="eligibility">
        <div className="container">
          <h2>
            What Are The Eligibility Criteria For The My Scope Personal Loan DSA
      ...
      {/* section 7 */}
      <div className="container my-5 document">
        <h2>Features And Earnings of Personal Loan DSA Program</h2>
        <p>
